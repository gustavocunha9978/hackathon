  ...
  return [
    {
      ...
      descricao: 'Evento anual para apresentação de inovações tecnológicas da faculdade',
  ...
  export async function getAvaliacoes(userId = null) {
    ...
    const avaliacoes = [
      ...
      },
      {
        id: 3,
        artigo_id: 3,
        artigo_titulo: 'Avanços em Biotecnologia para Tratamento de Doenças Raras',
        nota: 8.0,
    ...
    if (userId) {
      return avaliacoes.filter(avaliacao => avaliacao.avaliador_id === parseInt(userId));
    }
