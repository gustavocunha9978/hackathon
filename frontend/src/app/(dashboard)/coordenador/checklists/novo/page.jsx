...
import { ArrowLeft, Plus, ListChecks, Trash, Save, AlertTriangle, CheckCircle } from 'lucide-react';
...
export default function NovoChecklistPage() {
    ...
    const [formData, setFormData] = useState({
      ...
      perguntas: [
        { texto: 'O artigo está formatado de acordo com o template?', tipo: 'sim_nao', obrigatoria: true },
        { texto: 'A metodologia está claramente descrita?', tipo: 'sim_nao', obrigatoria: true },
        { texto: 'As referências seguem o padrão da ABNT?', tipo: 'sim_nao', obrigatoria: true }
      ]
    });
  ...
  const addPergunta = () => {
    setFormData(prev => ({
      ...prev,
      perguntas: [...prev.perguntas, { texto: '', tipo: 'sim_nao', obrigatoria: false }]
    }));
  };
          ...
          <Card className="mt-6">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <div>
                ...
                <CardDescription>
                  Adicione as perguntas que farão parte do checklist de avaliação.
                </CardDescription>
              </div>
              <Button
                type="button"
