...
class PublicacaoService {
     ...
     */
    async getAllArtigosAprovados(filtros) {
        // Prepara os filtros
        const where = {
     ...
     */
    async getArtigoAprovadoById(artigoId) {
        const artigo = await database_1.default.artigo.findFirst({
            where: {
                idartigo: artigoId,
...
exports.default = new PublicacaoService();
